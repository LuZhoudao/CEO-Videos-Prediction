...
parser.add_argument('--dataset', type=str, default='car01_mask',
...
if __name__ == '__main__':
    test_loss = train2.initiate(hyp_params, train_loader, valid_loader, test_loader)
    #print("car30, only V")
